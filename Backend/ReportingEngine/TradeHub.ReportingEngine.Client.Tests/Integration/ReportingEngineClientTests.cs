...
namespace TradeHub.ReportingEngine.Client.Tests.Integration
{
    [TestFixture]
    public class ReportingEngineClientTests
    {
        private ReportingEngineClient _reportingEngineClient;

        [SetUp]
        public void Setup()
        {
            _reportingEngineClient = ContextRegistry.GetContext()["ReportingEngineClient"] as ReportingEngineClient;
        }
