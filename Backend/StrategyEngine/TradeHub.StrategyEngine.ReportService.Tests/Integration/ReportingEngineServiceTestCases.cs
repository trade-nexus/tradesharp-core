...
namespace TradeHub.StrategyEngine.ReportService.Tests.Integration
{
    [TestFixture]
    public class ReportingEngineServiceTestCases
    {
        private ReportingEngineService _reportingEngineService;

        [SetUp]
        public void Setup()
        {
            _reportingEngineService = ContextRegistry.GetContext()["ReportingEngineService"] as ReportingEngineService;
        }
        ...
        public void RequestOrderReport_RetrieveResults_Successful()
        {
            ...
            if (_reportingEngineService != null)
            {
                var manualReportEvent = new ManualResetEvent(false);

                // Hook Event
                _reportingEngineService.OrderReportReceivedEvent += delegate(IList<object[]> obj)
                {
                    report = obj;
                ...
                _reportingEngineService.RequestOrderReport(arguments);
        ...
        public void RequestProfitLossReport_AddTradesToDatabaseForTheIntendedReport__RetrieveResults_Successful_DeleteAddedEntries()
        {
            ...
            if (_reportingEngineService != null)
            {
                ...
                // Hook Event
                _reportingEngineService.ProfitLossReportReceivedEvent += delegate(ProfitLossStats obj)
                {
                    report = obj;
                    dataEventReceived = true;
                    manualReportEvent.Set();
                ...
                _reportingEngineService.RequestProfitLossReport(arguments);
