...
using TradeHub.OrderExecutionProvider.Redi.Provider;
using Constants = TradeHub.Common.Core.Constants;

namespace TradeHub.OrderExecutionProvider.Redi.Tests.Integration
{
    [TestFixture]
    public class OrderExecutionProviderTestCases
    {
        private RediOrderExecutionProvider _executionProvider;

        [SetUp]
        public void SetUp()
        {
            _executionProvider = new RediOrderExecutionProvider();
        }
        ...
        {
            MarketOrder marketOrder = new MarketOrder(Constants.OrderExecutionProvider.Redi)
                {
                    OrderID = "5000",
        ...
        {
            LimitOrder limitOrder = new LimitOrder(Constants.OrderExecutionProvider.Redi)
            {
                OrderID = "5000",
                Security = new Security { Symbol = "EURUSD" },
