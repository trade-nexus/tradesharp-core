...
using TradeHub.OrderExecutionProvider.Integral.Provider;
using Constants = TradeHub.Common.Core.Constants;

namespace TradeHub.OrderExecutionProvider.Integral.Tests.Integration
{
    [TestFixture]
    public class OrderExecutionProviderTestCases
    {
        private IntegralOrderExecutionProvider _executionProvider;

        [SetUp]
        public void SetUp()
        {
            _executionProvider = new IntegralOrderExecutionProvider();
        }
        ...
        {
            MarketOrder marketOrder = new MarketOrder(Constants.OrderExecutionProvider.Integral)
                {
                    OrderID = "5000",
        ...
        {
            LimitOrder limitOrder = new LimitOrder(Constants.OrderExecutionProvider.Integral)
            {
                OrderID = "5000",
                Security = new Security { Symbol = "EURUSD" },
