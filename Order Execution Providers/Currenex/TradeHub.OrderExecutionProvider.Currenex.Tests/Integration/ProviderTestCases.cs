...
using TradeHub.OrderExecutionProvider.Currenex.Provider;
using Constants = TradeHub.Common.Core.Constants;

namespace TradeHub.OrderExecutionProvider.Currenex.Tests.Integration
{
    [TestFixture]
    public class OrderExecutionProviderTestCases
    {
        private CurrenexOrderExecutionProvider _executionProvider;

        [SetUp]
        public void SetUp()
        {
            _executionProvider = new CurrenexOrderExecutionProvider();
        }
        ...
        {
            MarketOrder marketOrder = new MarketOrder(Constants.OrderExecutionProvider.Currenex)
                {
                    OrderID = "5000",
        ...
        {
            LimitOrder limitOrder = new LimitOrder(Constants.OrderExecutionProvider.Currenex)
            {
                OrderID = "5000",
                Security = new Security { Symbol = "EURUSD" },
