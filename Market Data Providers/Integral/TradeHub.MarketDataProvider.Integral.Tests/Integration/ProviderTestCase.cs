...
using TradeHub.MarketDataProvider.Integral.Provider;

namespace TradeHub.MarketDataProvider.Integral.Tests.Integration
{
    [TestFixture]
    public class ProviderTestCase
    {
        private IntegralMarketDataProvider _marketDataProvider;
        [SetUp]
        public void SetUp()
        {
            _marketDataProvider = new IntegralMarketDataProvider();
        }
